        ...
        try:
            with self._db_lock:
                ...
                new_telemetry_cols = [
                    ...
                    ("camber_fl", "REAL"), ("camber_fr", "REAL"),
                    ("camber_rl", "REAL"), ("camber_rr", "REAL"),
        ...
        try:
            with self._db_lock:
                ...
                self.telemetry_buffer.append({
                    ...
                    "camber_fl": sample.get("camber_fl", 0.0),
                    "camber_fr": sample.get("camber_fr", 0.0),
                    "camber_rl": sample.get("camber_rl", 0.0),
                    "camber_rr": sample.get("camber_rr", 0.0),
